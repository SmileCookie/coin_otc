...
//usdt
export const fetchAssetsTotal = () => (dispatch) => {
        let langs = "USD";
...
//otc
export const fetchOtcAssetsTotal = () => (dispatch) => {
    let langs = "USD";
...
//钱包
export const fetchrWalletTotal = () => (dispatch) => {
...
export const fetchTransAssetsTotal = () => (dispatch) => {
     let langs = "USD";
