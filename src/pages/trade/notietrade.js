...
import EntrustrecordContainer from './entrustrecord/entrustrecordContainer';
import Practice from './practice/practiceContainer';
import KlineAndDepthChart from './klineOrDepthChart'
import { DOMAIN_VIP,DISMISS_TIME,COOKIE_MONEY,HEADER_HEIGHT,PAGEMINHEIGHT,ERRORCONFIG } from '../../conf/index'
import SellBuy from './sellbuy/sellBuyFormContainer'
import Tradehistory from './history/historyContainer';
import {setIsHasAuthGoogleAndIp} from '../../redux/modules/session';
import ReactModal from '../../components/popBox';
import { formatDate, pointCount } from '../../utils';
...
class NotIeTrade extends React.Component {
    constructor(props){
        super(props)
        this.state = {
            buyPrice:0,
...
export default connect(mapStateToProps, mapDispatchToProps)(NotIeTrade);