...
class OctCapitalFrozen extends React.Component {
    ...
    detailRefresh(fundsType) {
        this.setState({ modalStr: <Transfer closeModal={this.modal.closeModal} fromtype={1} totype={2} fundsType="" /> })
    }
    recordDetails() {

        let template = (<div className="copitalModal coFont11 capitalDealContent">
            ...
            <ul className="copitalModalList coFont11 f-14">
                ...
                <li>
                    <span>冻结余额</span>
                    <span>12.00000000BTC</span>
                </li>
                <li>
                    <span><FormattedMessage id="otc时间" /></span>
                    <span>2017-9-8 10:22:32</span>
                </li>
                <li className="copitalModalListNote coFont14">
                    <span><FormattedMessage id="otc备注" />:&nbsp;&nbsp;<FormattedMessage id="otc发布出售广告，平台提前冻结出售货币。" /></span>
                </li>
            </ul>
    ...
    render() {
        ...
        return (
            <div className="dealContent coFont1 f-14 coFont1">
                <h2 className="capitalTitle">冻结记录</h2>
                    ...
                    <div className="capitalActions">
                        ...
                        <div className="capitalExportButton">
                            <div className="history_list_right">
                                <Link to="/"><div className="history_list">导出冻结记录</div></Link>
                            </div>
                        </div>
                    </div>
