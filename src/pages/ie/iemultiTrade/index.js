...
import ItemTypes from "../../trade/dnd/ItemTypes";
import cookie from "js-cookie";
import {fetchMultiTrade, receiveMutili} from "../../../redux/modules/trade";
import '../../trade/dnd/dustbin.less'
// import Dustbin from "../../../trade/dnd/dustbin";
const update = require('immutability-helper')

// IE 多屏看板组件
class IeMultiTrade extends React.Component{
    constructor(props) {
        super(props)
        this.state = {
            dustbins: [
...
export default connect(mapStateToProps,mapDispatchToProps)(IeMultiTrade)