...
import { arrayTimeToStr_ymd, dateToFormat_ymd,ckd } from 'Utils';
...
@Decorator()
export default class HandicapUserTransactions extends React.Component {
    constructor(props) {
        super(props)
        this.defaultState = {
            time: [moment(),moment()],
    ...
    requestTable = async (currIndex, currSize) => {
        ...
        const result = await this.request({ url: '/tradeAnalysis/marketQuery', type: 'post' }, params)
        this.setState({
    ...
    createColumns = () => {
        ...
        return [
            ...
            { title: '买入人数', dataIndex: 'buyNum', },
            { title: '卖出人数', dataIndex: 'sellNum' },
            { title: '合计交易人数', dataIndex: 'sumNum' },
