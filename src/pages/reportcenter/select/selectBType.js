...
export default class SelectBType extends React.Component{
    ...
    render(){
        ...
        return (
            <div className="form-group">
                <label className={this.props.col? 'col-sm-'+this.props.col+' control-label' :'col-sm-2 control-label'} >交易类型：</label>
