...
//         //tableScroll(`#${this.state.tableScroll.tableId2}`,'add',`#${this.state.tableScroll.x_panelId2}`,this.getHeight)
//     }
//     componentWillUnmount(){
//         tableScroll(`#${this.state.tableScroll.tableId}`)
//         //tableScroll(`#${this.state.tableScroll.tableId2}`)
//     }
//     getHeight(xheight){
//         this.setState({
//             xheight
...
//     //统计选中金额弹窗
//     countChecked(type,btnType){
//         let params;
//         const { status,auditType } = this.state
//         if(type == 'all'){
//             params = ""
//         }else{
...
//             const result = res.data
//             if(result.code == 0){
//                 console.log(item.afterAmount)
//                 const sureBtn = item.afterAmount > result.data.finanaccountList[0].amount;
//                 console.log(sureBtn)
//                 this.setState({
//                     sureBtn,
//                     hasAmount:result.data.finanaccountList[0].amount,
//                 },()=>this.palySurecoin(item))
//             }
//         })
//     }
...
//         this.footer = [
//             <Button key="back" onClick={this.handleCancel}>取消</Button>,
//             <Button key="submit" type="more" disabled={this.state.sureBtn} loading={this.state.loading} onClick={() => this.modalGoogleCode(item,'sure')}>
//                 确认打币
//             </Button>,
//         ]
...
//         this.setState({
//             visible:true,
//             modalHtml:<ModalSure item={item} hasAmount={hasAmount}/>,
...
//                                 <div className="x_content">
//                                     <div id={this.state.tableScroll.tableId}  style={{height:`${this.state.tableViewList.length>10?this.state.tableScroll.defaultHeight+this.state.height+'px':''}`}} className="table-responsive-yAuto">
...
//                                 <div className="x_content">
//                                     <div className="col-mg-4 col-lg-6 col-md-4 col-sm-4 col-xs-4">
//                                         <SelectAType findsType={auditType} paymod col='3' handleChange={this.handleChangeAudit}></SelectAType>
//                                     </div>        
//                                     <div className="col-mg-4 col-lg-6 col-md-4 col-sm-4 col-xs-4">
...
//                                         {limitBtn.indexOf('choseCount')>-1?<Button type="more" onClick={() => this.countChecked('part','swap')}>统计选中金额</Button>:''}
//                                         {limitBtn.indexOf('choseCount')>-1?<Button type="more" onClick={() => this.countChecked('all','swap')}>统计全部金额</Button>:''}
//                                         {limitBtn.indexOf('confirmAll')>-1?(status==1&&<Button type="more" onClick={() => this.countChecked('all','playCoin')}>全部打币</Button>):''}
//                                         {limitBtn.indexOf('confirmAll')>-1?(status==1&&<Button type="more" onClick={() => this.countChecked('part','playCoin')}>选中打币</Button>):'' }                                       
//                                     </div>
...
//                                      {
//                                          status == 1? 
//                                             <Table dataSource={tableSource} rowSelection={rowSelection} bordered pagination={pagination}>
...
//                                                 <Column title="提现金额" dataIndex="amount"  />  
//                                                 <Column title="实际金额" dataIndex="afterAmount"/>  
//                                                 <Column title="申请时间" dataIndex="submittime" />  
//                                                 <Column title="提现地址" dataIndex="toaddress" />  
//                                                 <Column title="资金状态" dataIndex="customerOperationName"  render={(text, record,index) => (
//                                                     (() => {
//                                                         if(text == '异常'){
...
//                                                     <span>
//                                                         {limitBtn.indexOf('confirmCancel')>-1?<a href="javascript:void(0)" className="mar10" onClick={()=> this.onConfirmCancel(record,'cancel')}>取消</a>:''}
//                                                         {limitBtn.indexOf('confirmSuc')>-1?<a href="javascript:void(0)" className="mar10" onClick={()=> this.setSureBtn(record,'sure')}>确认</a>:''}           
//                                                     </span>
//                                                 )} />  
//                                             </Table>
//                                          :
...
//                                                 <Column title="资金状态" dataIndex="customerOperationName" key="customerOperationName" render={(text, record,index) => (
//                                                     (() => {
//                                                         if(text == '异常'){
//                                                             return <span><a href="javascript:void(0)"  className="mar10" onClick={()=> this.seeCustomerOpe(tableSource[index].userid)}>{text}</a></span>  
//                                                            }else{
