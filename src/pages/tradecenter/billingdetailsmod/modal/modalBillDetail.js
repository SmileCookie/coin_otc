...
export default class ModalBillDetail extends React.Component{
    ...
    requestTable(currIndex,currSize,currId,currKey){
        ...
        if(fundsType!=0||type!=0||id||userId||startDate||endDate||userName){
            axios.post(DOMAIN_VIP+'/billDetail/query',qs.stringify({
        ...
        return(
            <div className="x_panel">
                <div className="x_content">
                    ...
                    <div id={this.state.tableScroll.tableId}  style={{height:`${tableList.length>10?this.state.tableScroll.defaultHeight+this.state.height+'px':''}`}} className="table-responsive-yAuto">
                                    ...
                                    tableList.map((item,index) => {
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td className='moneyGreen'>{toThousands(item.fees,true)}</td>
