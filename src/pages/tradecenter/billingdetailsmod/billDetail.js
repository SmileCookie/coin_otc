...
import qs from 'qs'
import { DOMAIN_VIP,PAGEINDEX,PAGESIZE,TIMEFORMAT,DAYFORMAT,TIMEFORMAT_ss,URLS } from '../../../conf'
import ModalBillDetail from './modal/modalBillDetail'
...
export default class BillDetail extends React.Component{
    ...
    componentDidMount(){
        console.log( moment(new Date()).format(DAYFORMAT))
        console.log(moment(1542383999000).format(TIMEFORMAT_ss))
