...
import ModalAutoLightenManageFT from './modal/modalAutoLightenManageFT'
import HandicapMarket from '../../common/select/handicapMarketFT'
const { RangePicker} = DatePicker
const {Column} = Table
const Option = Select.Option

export default class AutoLightenManageFT extends React.Component{
    constructor(props){
        super(props)
        this.state = {
            showHide:true,
    ...
    checkDetail = item => {
        ...
        this.setState({
            ...
            title:"详情",
            width:'1200px',
            modalHtml:<ModalAutoLightenManageFT />
        })
    }
    ...
    render(){
        const { showHide,tableSource,pagination,pageIndex,pageSize,pageTotal,time,width,modalHtml,visible,title, } = this.state
        return(
            <div className="right-con">
                <div className='page-title'>
                    当前位置： 数据中心 > 期货交易中心 > 自动减仓管理
                            ...
                            <div className='x_content'>
                                ...
                                <div className="col-mg-4 col-lg-6 col-md-4 col-sm-4 col-xs-4">
                                    <div className="form-group">
                                        ...
                                        <div className="col-sm-8">
                                            <input type="text" name='' className="form-control" onChange={this.handleInputChange}/>
                                            <b className="icon-fuzzy">%</b>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className='col-mg-4 col-lg-6 col-md-4 col-sm-4 col-xs-4'>
                                    <div className="form-group">
                                        <label className="col-sm-3 control-label">仓位数量:</label>
                                        <div className="col-sm-8">
                                ...
                                <div className='col-mg-4 col-lg-6 col-md-4 col-sm-4 col-xs-4'>
                                    <div className="form-group">
                                        <label className="col-sm-3 control-label">减仓数量:</label>
                                        <div className="col-sm-8">
                                            <div className="col-sm-4 left sm-box">
                                                <input type="text" name='' className="form-control" onChange={this.handleInputChange}/>
                                            </div>
                                ...
                                <div className='col-mg-4 col-lg-6 col-md-4 col-sm-4 col-xs-4'>
                                    <div className="form-group">
                                        <label className="col-sm-3 control-label">减仓盈亏:</label>
                                        <div className="col-sm-8">
                                            <div className="col-sm-4 left sm-box">
                                                <input type="text" name='' className="form-control" onChange={this.handleInputChange}/>
                                            </div>
                                ...
                                <div className="right">
                                    <div className="form-group right">
                                        ...
                                        <a href='javascript:void(0);' onClick={()=>this.checkDetail()}>暂时没有对接口</a>
                                    </div>
                                </div>
                            </div>
                        </div>}
                            ...
                            <div className="x_content">
                                <div className="table-responsive">
                                    ...
                                    <Table tableSource={tableSource} bordered pagination={pagination} onChange={this.sorter} locale={{emptyText:'暂无数据'}} >
                                        ...
                                        <Column title='仓位数量' sorter dataIndex='' key=''/>
                                        <Column title='减仓数量' sorter dataIndex='' key=''/>
                                        <Column title='减仓价格' dataIndex='' key=''/>
                                        <Column title='减仓价值' dataIndex='' key=''/>
                                        <Column title='减仓保证金' dataIndex='' key=''/>
                                        <Column title='减仓盈亏' sorter dataIndex='' key=''/>
                                        {/* <Column title='买方委托编号' dataIndex='' key=''/> */}
                                        {/* <Column title='卖方委托编号'  dataIndex='' key=''/> */}
                                        <Column title='委托时间'  dataIndex='' key=''/>
                                        <Column title='详情'  dataIndex='' key='' render={(text,record) => (
                                            <a href='javascript:void(0);' onClick={()=>this.checkDetail(record)}>查看详情</a>
                                        )}/>
                                    </Table>
                                </div>
                            </div>
