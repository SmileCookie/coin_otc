...
export default class ModalAutoLightenManageFT extends React.Component{
    constructor(props){
        super(props)
        this.state= {
            tableSource:[],
            ...
            <div className='col-md-12 col-sm-12 col-xs-12'>
                <div className="table-responsive">
                    <Table tableSource={tableSource} bordered  scroll={{x:1500}} locale={{emptyText:'暂无数据'}}>
                        ...
                        <Column title='保险基金' fixed='right' dataIndex='' key=''/>
                        <Column title='爆仓时间' fixed='right' dataIndex='' key=''/>
                        <Column title='是否穿仓' fixed='right' dataIndex='' key=''/>
                    </Table>
                </div>
            </div>
        )
