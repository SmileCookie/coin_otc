...
// export default class BatchEntrustFT extends React.Component{
...
//     render(){
//         const { market,type,minPrice,maxPrice,totalAmount,totalCount,userId,visible,width,title,modalHtml,limitBtn } = this.state
//         return(
//             <div className="right-con">
//                 <div className="page-title">
//                     当前位置：数据中心> 期货交易中心 > 盘口管理 > 期货批量挂单
//                 </div>
...
//                                     <div className="col-md-12 col-sm-12 col-xs-12">
//                                         <div className="form-group">
//                                             <label className="col-sm-4 control-label">委托类型:</label>
//                                             <div className="col-sm-8">
//                                                 <RadioGroup onChange={this.handleInputChange} name="type" value={type}>
//                                                     <Radio value={1}><span className="font_green">多开</span></Radio>
//                                                     <Radio value={0}><span className="font_red">空开</span></Radio>
//                                                     <Radio value={1}><span className="font_green">空平</span></Radio>
//                                                     <Radio value={0}><span className="font_red">多平</span></Radio>
//                                                 </RadioGroup>
//                                             </div>
//                                         </div> 
//                                     </div>
...
//                                     <div className="col-md-12 col-sm-12 col-xs-12">
//                                         {<Button className="marl50" type="more" size="large" onClick={this.requestTable}>批量下单</Button>}
//                                     </div>
