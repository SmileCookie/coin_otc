...
export default class BrushTaskManage extends React.Component {
    ...
    requestTable(){
        axios.get(DOMAIN_VIP+"/brush/task/fkDealList").then(res => {
    ...
    startBrushTaskBtn(market){
        ...
        return new Promise((resolve, reject) => {
            axios.get(DOMAIN_VIP+'/brush/task/FkDealStart',{params:{
                market:market
            }}).then(res => {
                const result = res.data;
                if(result.code == 0){
    ...
    stopBrushTaskBtn(market){
        let self = this
        return new Promise((resolve, reject) => {
            axios.get(DOMAIN_VIP+'/brush/task/stopFKDeal',{
                params:{
                    market:market
                }
            }).then(res => {
    ...
    allStartTaskBtn(){
        axios.get(DOMAIN_VIP+"/brush/task/allDealFKStart").then((res) => {
            const result = res.data
            if(result.code == 0){
                this.requestTable()
            }
    ...
    allStopTaskBtn(){
        axios.get(DOMAIN_VIP+"/brush/task/allDealFKStop").then((res) => {
            const result = res.data
            if(result.code == 0){
                this.requestTable()
            }
