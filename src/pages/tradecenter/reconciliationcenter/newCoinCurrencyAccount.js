...
export default class CoinCurrencyAccount extends React.Component {
    ...
    render() {
        Big.RM = 0;
        const { state,showHide, fundsType, tableList, time, pageIndex, pageSize, pageTotal} = this.state
        return (
                                ...
                                <div className="table-responsive">
                                    ...
                                    <Table
                                        ...
                                        pagination={{
                                            ...
                                            <Column title={<React.Fragment>平台对账<br/>(E-F)-(G+H)</React.Fragment>} dataIndex="difference" key="platformReconciliation" className="moneyGreen" render={(text)=>toThousands(text,true)} />
