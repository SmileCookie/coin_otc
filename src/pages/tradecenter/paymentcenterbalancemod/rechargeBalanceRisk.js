...
export default class RechargeBalance extends React.Component{
    ...
    componentDidMount(){
        this.requestTable()
        this.setState({
            limitBtn: pageLimit('rechargeBalance', this.props.permissList)
    ...
    requestTable(currIndex,currSize){
        ...
        axios.post(DOMAIN_VIP+'/rechargeBalanceWindcontrol/queryOfRecharges',qs.stringify({
            bgdetailsid:bgDetailsId,fundstype:fundType,
    ...
    render(){
        const {showHide,bgDetailsId,time,tableList,current,fundType,pmStatus,accountType,balanceFlag,pmBlockHeightOfStart,pmBlockHeightOfEnd,pageIndex,pageSize,pageTotal,limitBtn}=this.state
        return(
            <div className="right-con">
                <div className="page-title">
                    当前位置：对账中心 > 支付中心对账 > 充值对账（风控）
                    ...
                    <div className="row">
                        ...
                        {showHide &&<div id={this.state.tableScroll.x_panelId} className="x_panel">
                            <div className="x_content">
                                ...
                                <div className="col-mg-4 col-lg-6 col-md-4 col-sm-4 col-xs-4">
                                    <FundsTypeList col='3' paymod="1" fundsType={fundType} handleChange={this.handleChangeType} />
                                </div>
                                {/* <div className="col-mg-4 col-lg-6 col-md-4 col-sm-4 col-xs-4">
                                    <div className="form-group">
