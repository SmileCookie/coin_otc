...
export default class WithdrawBalance extends React.Component {
    ...
    requestTable(currIndex, currSize) {
        ...
        axios.post(DOMAIN_VIP + '/withdrawBalance/queryOfWithdraw', qs.stringify({
            bgDownloadId, fundType, pmStatus, balanceFlag, pmConfigTimeOfStart, pmConfigTimeOfEnd, pmBlockHeightOfStart, pmBlockHeightOfEnd,
    ...
    render() {
        const { showHide, bgDownloadId, time, tableList, fundType, pmStatus, accountType, balanceFlag, pmBlockHeightOfStart, pmBlockHeightOfEnd, pageIndex, pageSize, pageTotal } = this.state
        // console.log(tableList)
        const isYes = { color: 'red' }
        return (
            <div className="right-con">
                <div className="page-title">
                    当前位置：对账中心 > 支付中心对账 > 提现对账
