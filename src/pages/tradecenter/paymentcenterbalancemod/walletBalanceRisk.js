...
export default class WalletBalance extends React.Component {
    ...
    componentDidMount() {
        this.requestTable()
        this.setState({
            limitBtn: pageLimit('walletBalance', this.props.permissList)
    ...
    render() {
        const { showHide, checkTimeStart, tableList, fundsType, checkTimeEnd, time, blockHeightStart, blockHeightEnd, pageIndex, pageSize, pageTotal, limitBtn } = this.state
        return (
            <div className="right-con">
                <div className="page-title">
                    当前位置：对账中心 > 支付中心对账 > 钱包每日对账（风控）
                        ...
                        {showHide && <div id={this.state.tableScroll.x_panelId} className="x_panel">
                            <div className="x_content">
                                <div className="col-mg-4 col-lg-6 col-md-4 col-sm-4 col-xs-4">
                                    <FundsTypeList col='3' fundsType={fundsType} handleChange={this.handleChangeType}></FundsTypeList>
                                </div>
                                <div className="col-mg-4 col-lg-6 col-md-4 col-sm-4 col-xs-4">
                                        ...
                                        <tbody>
                                            {
                                                tableList.length > 0 ?
                                                    ...
                                                    <tr className="no-record"><td colSpan="25">暂无数据</td></tr>
                                            }
                                        </tbody>
                                    </table>
                                </div>
