...
export default class  WithdrawError extends Component {
    constructor(props) {
        super(props)
        this.state = {
            showHide: true,
    ...
    requestTable = (currentIndex, currentSize) => {
        ...
        axios.post(DOMAIN_VIP+'/coinChangeCxception/list',qs.stringify({
             userid,
             fundstype:fundsType,
            ...
            if(result.code == 0){
                ...
                for(let i=0;i<tableSource.length;i++){
                    ...
                    tableSource[i].unauditedtime = timeChange(tableSource[i].unauditedtime)
                }
                this.setState({
                            ...
                            <div className="x_content">
                                <div className="table-responsive">
                                    ...
                                    >
                                        ...
                                        <Column title='提现金额' className="moneyGreen" dataIndex='amount' key='amount' />
                                        <Column title='提现发起时间'  dataIndex='submittime' key='submittime' />
                                        <Column title='未审核时长（分）'  dataIndex='unauditedtime' key='unauditedtime' />
