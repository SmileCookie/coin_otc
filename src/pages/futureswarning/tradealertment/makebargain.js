...
const {Column} = Table
class Makebargain extends Component{
    constructor(props){
        super(props);
        this.state ={
            googVisibal:false,
    ...
    batchMarking() {
        ...
        Modal.confirm({
            ...
            cancelText: '取消',
            onOk() {
                axios.post(DOMAIN_VIP + '/frequent/update', qs.stringify({})).then(res => {
                    const result = res.data;
                    if (result.code == 0) {
                        this.setState({
                            RowKeys: []
    ...
    render(){
        const {time,pageSize,showHide,tableSource,pagination,googVisibal,check, conversionS, conversionE,userid,visible,title,width,pageIndex,RowKeys} = this.state
        return (
                       ...
                       <div className="x_content">
                           ...
                           <div className="col-md-4 col-sm-4 col-xs-4 right">
                                    <div className="form-group right">
                                        ...
                                        <Button type="primary" onClick={this.batchMarking}>批量标记</Button>
                                    </div>
                            </div>
