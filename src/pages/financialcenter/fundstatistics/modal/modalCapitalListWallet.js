...
export default class ModalCapitalList extends React.Component{
    ...
    constructor(props){
        ...
        this.state = {
            ...
            height:0,
            tableScroll:{
                tableId:'MDALCATLWALT',
                x_panelId:'MDALCATLWALTXX',
                defaultHeight:500,
            }
        }
    ...
    requestTable(currIndex,currSize){
        ...
        axios.post(DOMAIN_VIP+'/walletCapitalCount/query',qs.stringify({
                                    ...
                                    tableList.map((item,index) => {
                                        ...
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td>{toThousands(new BigNumber(item.freez).minus(item.withdrawfreeze).toFixed())}</td>
                                            </tr>
                                        )
                                    })
