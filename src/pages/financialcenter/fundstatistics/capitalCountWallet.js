...
import qs from 'qs'
import ModalCapitalList from './modal/modalCapitalListWallet'
import { DOMAIN_VIP,PAGEINDEX,PAGESIZE } from '../../../conf'
import SelectAType from '../select/selectAType'
import { Button,Pagination } from 'antd'
const BigNumber = require('big.js')

export default class CapitalCountWallet extends React.Component{
    ...
    render(){
        const { showHide,fundsType,totalMoneyMin,totalMoneyMax,pageTotal,tableList,pageIndex,pageSize,isreLoad,userId,userName,minBalance,maxBalance,borrowMin,borrowMax,freezMin,freezMax,withDrawMin,withDrawMax,lendingMin,lendingMax,entrustMin,entrustMax } = this.state
        return(
            <div className="right-con">
                <div className="page-title">
                    当前位置：财务中心 > 资金统计 > 钱包资金统计
