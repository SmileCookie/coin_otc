    ...
    render(){
        ...
        return(
            <div className="col-md-12 col-sm-12 col-xs-12">
                ...
                <div className="col-md-12 col-sm-12 col-xs-12">
                    <div className="form-group">
                        <label className="col-sm-3 control-label">地址校验：</label>
                        <div className="col-sm-8">
                            <span className={`line34 ${this.props.errorType == 0 ? 'font_green': 'font_red'}`}>{['通过','API接口调用失败','地址校验失败'][this.props.errorType]}</span>
                        </div>
                    </div>
                </div>
            </div>
