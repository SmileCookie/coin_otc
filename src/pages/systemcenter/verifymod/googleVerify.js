...
import { Button,DatePicker,Select,Tabs,Pagination,Modal,message } from 'antd'
import { DOMAIN_VIP,PAGEINDEX,PAGESIZE,TIMEFORMAT,SELECTWIDTH,PAGRSIZE_OPTIONS20 } from '../../../conf/index';
...
export default class UserCapital extends React.Component{
    ...
    componentDidMount(){
        this.requestTable()
        this.setState({
            limitBtn: pageLimit('googleVerify', this.props.permissList)
        })
    ...
    requestTable(currIndex,currSize,currKey){
        ...
        axios.post(DOMAIN_VIP+'/googleVerify/queryList',qs.stringify({
    ...
    onAuditGoogle(id){
        ...
        let url = tab==0?"/googleVerify/see":"/googleVerify/onlySee"
        axios.post(DOMAIN_VIP+url,qs.stringify({
            ...
            if(result.code == 0){
                this.footer=[
                    ...
                    <Button key="submit" type="more" loading={this.state.loading} onClick={tab==0?()=>this.passGoogleCode(id):() => this.onAuditGoogleBtn(id)}>
                        确认
                    </Button>,
                ]
                this.setState({
                    ...
                    <div className="col-md-12 col-sm-12 col-xs-12">
                        {showHide&&<div id={this.state.tableScroll.x_panelId} className="x_panel">
                            <div className="x_content">
                                ...
                                <div className="col-mg-4 col-lg-6 col-md-4 col-sm-4 col-xs-4">
                                    <div className="form-group">
                                        <label className="col-sm-3 control-label">验证旧Google：</label>
                                        <div className="col-sm-8">
                                    ...
                                    <table className="table table-striped jambo_table bulk_action table-linehei table_scroll">
                                        <thead>
                                            <tr className="headings">
                                                ...
                                                <th className="column-title">验证旧Google</th>
