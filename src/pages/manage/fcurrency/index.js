...
class Balance extends React.Component {
    ...
    detailRefresh(fundsType) {
        this.setState({ Mstr: <Transfer closeModal={this.modal.closeModal} fromtype={3} totype={1} fundsType={fundsType} /> })
    }
    ...
    render() {
        ...
        let storeFreez = null
        if(this.props.assets.detail.data){
            let _data = this.props.assets.detail.data
            storeFreez = _data.USDT.storeFreez
        }         
            ...
            <div className="bk-assets">
               <div className="cont-row">
                    ...
                    <div className="bbyh-moneyHeader">
                        ...
                        <h2 className="assets-title chooseTitle" onClick={() =>browserHistory.push(formatURL('/manage/account/fcurrency'))}><FormattedMessage id="法币账户"/></h2>
                    ...
                    <div className="assets-detail-right">
                        <div className="assets-detail-value">
                            ...
                            <div>
                                <b style={{"lineHeight":"20px",paddingLeft:"20px"}}><FormattedMessage id="保证金：" /></b>
                                <div className="val-con" style={{"lineHeight":"20px",paddingLeft:'8px'}}>
                                    <em id="totalBtc">{storeFreez ? new BigNumber(storeFreez).toFixed(8) : '0.00000000'}</em> USDT
                                </div>
                            </div>
                    ...
                    <div className="history_list_right">
                        <Link to="/bw/manage/account/fbchargeDownHistory?type=1"><div className="history_list"><FormattedMessage id="历史记录" /></div></Link>
                    </div>
                </div>
...
const mapStateToProps = (state, ownProps) => {
    return {
        coinList: state.otcDetail.detail,
