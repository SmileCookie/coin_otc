...
@Form
class DEbUpMobile extends React.Component{
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        ...
        this.props.getUserBaseInfo().then(r => {
            if(r.mobileStatus === 2){
                browserHistory.push(formatURL(EBMOBILE));
            }
        });
    }
    render(){
