...
export default class SelectHistory extends React.Component{
    ...
    componentWillReceiveProps(nextProps){
        ...
        if(!nextProps.ckFlg && this.props.defaultValue != undefined ){
            const defaultItem =this.props.options.find((item,index,arr) => {
                return item.val == this.props.defaultValue
            })
            if(defaultItem){
        ...
        if(nextProps.ckFlg && nextProps.defaultValue != undefined){
            const defaultItem = nextProps.options.find((item,index,arr) => {
                return item.val == nextProps.defaultValue
            })
            if(defaultItem){
                this.setState({
                    opval:defaultItem.val,
