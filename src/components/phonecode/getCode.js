    ...
    render(){
        ...
        return (
            <div className="country_select">
                <div className="input-group-btn dropdown" onMouseEnter={min} onMouseLeave={mout}>
                    <div className="btn-group">
                        <span id="countryText" onClick={this.setDropDownState}>{this.props.showCode == 0 ? this.state.currentCountry : this.state.currentCode}</span>
