...
import {partTimeJob,controlData} from '../api'
    ...
    sendSubmit(){
        ...
        partTimeJob(_obj).then((res) =>{
            ...
            if(res.isSuc){
                ...
                this.showStatusType();
                setTimeout(() =>{
                    browserHistory.push('/market/PartTimeSuccess')
                },2000)
        ...
        return (
            <div className="market-content">
                <div className="market-top">
                    <div className="big-title100"><FormattedMessage id="入职申请表"/></div>
                    ...
                    <div className="bo-center">
                        <div className="cen-input">
                            ...
                            <div className="input-common">
                                ...
                                <div className="input-cc">
                                    <div className="input-label"><i></i><FormattedMessage id="钱包地址"/></div>
                                    <div className="input-box">
                        ...
                        <div className="cooper-title">
                            <span className="partName" style={{fontSize:'36px'}}>
                                <FormattedMessage id="申请职位"/>
                            </span>
                            <div style={{fontSize:'24px',paddingTop:'50px',paddingBottom:'190px'}}>
                                <FormattedMessage id="数字资产交易所战略合作伙伴"/>
                            </div>
                        </div>
                    </div>
