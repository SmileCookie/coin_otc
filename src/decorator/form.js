...
import { isEmail,  isMobiles, isIdCardNo, isPassport, smpIsIdCardNo, } from '../utils';
import { changeImgCode } from '../redux/module/session';
...
// console.log(needImgCode, !code, errors, this.intl.formatMessage({id: "nuser6"}), rt);
        ...
        _ckprice(){
            ...
            this._isEmpty(this.state.price, errors, this.intl.formatMessage({id: "请输入单价金额"}));
            this._setError(KEY, errors);
        ...
        _ckbuyNum(){
            ...
            this._isEmpty(this.state.buyNum, errors, this.intl.formatMessage({id: "请输入出售数量"}));
            this._setError(KEY, errors);
        ...
        _ckminLimit(){
            ...
            this._isEmpty(this.state.minLimit, errors, this.intl.formatMessage({id: "请输入最小限额"}));
            this._setError(KEY, errors);
        ...
        _ckmaxLimit(){
            ...
            this._isEmpty(this.state.maxLimit, errors, this.intl.formatMessage({id: "请输入最大限额"}));
            this._setError(KEY, errors);
        ...
        _ckfundpassword() {
            let rt = true;
            const errors = [];
            const KEY = 'fundpassword';

            this._isEmpty(this.state.fundpassword, errors, this.intl.formatMessage({id: "请输入资金密码"}));
            this._setError(KEY, errors);
