...
(function($){$.bootstrapDropdownOnHover=function(element,options){var defaults={mouseOutDelay:500,responsiveThreshold:992,hideBackdrop:true};var plugin=this;plugin.settings={};var $container=$(element);var $W=$(window);var menuTimer=-1;plugin.init=function(){plugin.settings=$.extend({},defaults,options);$container.find("[data-toggle='dropdown']").each(function(i,el){var $trigger=$(el);var $menu=$trigger.parent().find(".dropdown-menu");var $parent=$trigger.parent();$trigger.on("mouseenter.bnoh",function(){if(isWithinResponsiveThreshold()){return;}clearTimeout(menuTimer);if(!$parent.hasClass("open")){var animation=$menu.attr('data-animation');$trigger.dropdown('toggle');if(animation){$menu.addClass(animation);$menu.on('animationend',function(){$menu.removeClass(animation);});}if(plugin.settings.hideBackdrop){$parent.find(".dropdown-backdrop").remove();}}});$trigger.on("mouseleave.bnoh",function(){if(isWithinResponsiveThreshold()){return;}menuTimer=setTimeout(function(){if($parent.hasClass("open")&&$parent.find(".dropdown-backdrop").length===0){$trigger.dropdown('toggle');$trigger.blur();var animation=$menu.attr('data-animation');if(animation){$menu.removeClass(animation);}}},plugin.settings.mouseOutDelay);});$menu.on("mouseenter.bnoh",function(){if(isWithinResponsiveThreshold()){return;}clearTimeout(menuTimer);});$menu.on("mouseleave.bnoh",function(){if(isWithinResponsiveThreshold()){return;}menuTimer=setTimeout(function(){if($parent.hasClass("open")){$trigger.dropdown('toggle');$trigger.blur();}},plugin.settings.mouseOutDelay);});});};plugin.destroy=function(){$container.find("[data-toggle='dropdown']").unbind(".bnoh");$container.find(".dropdown-menu").unbind(".bnoh");$container.removeData("bootstrapDropdownOnHover");};var isWithinResponsiveThreshold=function(){return $W.width()<=plugin.settings.responsiveThreshold;};plugin.init();};$.fn.bootstrapDropdownOnHover=function(options){return this.each(function(){if(undefined===$(this).data('bootstrapDropdownOnHover')){var plugin=new $.bootstrapDropdownOnHover(this,options);$(this).data('bootstrapDropdownOnHover',plugin);}});};})(jQuery);
...
var JuaBox = function(JuaId) {
		...
		this.btnClass1 = "btn btn-primary btn-sm";
		this.btnClass2 = "btn btn-outgray btn-sm";
		this.btnClass3 = "btn btn-outgray btn-sm";
		this.tipClass = "";
		...
		this.option = function(options){
			...
			this.frameWidth = options.frameWidth ? options.frameWidth : this.frameWidth ;
			this.frameHeight = options.frameHeight ? options.frameHeight : this.frameHeight ;
			this.btnNum = options.btnNum>=0 ? options.btnNum : this.btnNum ;
			this.btnName1 = options.btnName1 ? options.btnName1 : this.btnName1 ;
			this.btnName2 = options.btnName2 ? options.btnName2 : this.btnName2 ;
			this.btnName3 = options.btnName3 ? options.btnName3 : this.btnName3 ;
			this.btnClass1 = options.btnClass1 ? options.btnClass1 : this.btnClass1 ;
			this.btnClass2 = options.btnClass2 ? options.btnClass2 : this.btnClass2 ;
			this.btnClass3 = options.btnClass3 ? options.btnClass3 : this.btnClass3 ;
			this.tipClass  = options.tipClass ? options.tipClass : this.tipClass ;
			this.needLogin = options.needLogin != null ? options.needLogin : this.needLogin ;
			this.masking = options.masking != null ? options.masking : this.masking ;
			this.showMini = options.showMini != null ? options.showMini : JuaBox.isZoom() ? false : this.showMini ;
			this.showZoom = options.showZoom != null ? options.showZoom : JuaBox.isZoom() ? false : this.showZoom ;
			this.showClose = options.showClose != null ? options.showClose : this.showClose ;
			this.fullPage = options.fullPage != null ? options.fullPage : this.fullPage ;
			this.miniPage = options.miniPage != null ? options.miniPage : this.miniPage ;
			this.onlyOne = options.onlyOne != null ? options.onlyOne : this.onlyOne ;
			this.outFrame = options.outFrame != null ? options.outFrame : this.outFrame ;
			this.dragWindow = options.dragWindow != null ? options.dragWindow : this.dragWindow ;
			this.timeSetFrame = options.timeSetFrame != null ? options.timeSetFrame : this.timeSetFrame ;
			this.timeOutClose = options.timeOutClose != null ? options.timeOutClose : this.timeOutClose ;
			this.timeClose = options.timeClose ? options.timeClose : this.timeClose ;
  ...
  //               $("#JuaBox_"+JuaId).bind('mousemove',function(event){
		// 				var left = divLeft + (event.screenX - mouseX);
		// 				var top = divTop + (-event.screenY - mouseY);
  //                       console.log(mouseY+":"+left);
  //                       console.log(mouseX+":"+top);
		// 				$(this).css({
		// 					'top' :  top + 'px',
		// 					'left' : left + 'px'
		// 				});
		...
		this.position = function(JuaId,callBack){
			...
			$("#"+this.boxId).css({
				...
				"max-width" : JuaBox.isZoom() ? "410px" : "none",
            ...
            this.boxTop = Math.max(Math.max(this.winH - this.boxH,0)/2 + this.offsets.y, 0) ;
			this.boxLeft = this.fullPage ? 0 : Math.max(Math.max(Math.max(this.docW,this.winW) - this.boxW,0)/2 + this.offLeft + this.offsets.x, 0) ;
			$("#"+this.boxId).css({
				"top" : this.boxTop,
				"left" : this.boxLeft
			});
		...
		this.show = function(type){
			...
			if(type == 4){
				var navOffTop ;
				if($(".bk-nav").length > 0){
					navOffTop = $(".bk-nav").height() + $(".bk-nav").offset().top ;
				}else{
					navOffTop =  0 ;
				}
		...
		this.reSetHeight = function(JuaId,callBack){
			...
			if(JuaId != null || JuaId != undefined ){
	            ...
	            frameDoc.find(".bk-body").css("height","auto");
		...
		this.theme = {
			...
			info : function(){
				var themeHtml = "" ;	
					...
					themeHtml += "        <div class='bk-page-table'><div class='bk-page-tableCell'>${JuaBox.body}</div></div>";
					themeHtml += "    </div>";
			...
			bubble : function(){
				var themeHtml = "" ;	
					...
					themeHtml += "  <div class='Jua-table-inner'>";
					themeHtml += "    <div class='body'>";
					themeHtml += "        <div class='bk-page-table'><div class='bk-page-tableCell text-center'>${JuaBox.body}</div></div>";
					themeHtml += "    </div>";
					themeHtml += "  </div>";
					themeHtml += "</div>";
					return themeHtml ;
		...
		this.frame = function(frameUrl,options){
			this.type = 1 ;
			var targetUrl = frameUrl ? frameUrl : "";
			...
			this.option(options);
			if(JuaBox.isZoom()){this.fullPage = true ;}
			if($.isFunction(this.startFun)) { this.startFun() };
	...
	JuaBox.isMobile = function() {
		...
		var bIsTv = sUserAgent.match(/tv/i) == "tv";
		var bIsIpad = sUserAgent.match(/pad/i) == "pad";
	...
	JuaBox.mobileFontSize = function() {
	...
	//url转unicode
	function Benc() { this.enc = function (c) { c = unicodetoBytes(c); var a = ""; var k, h, f = ""; var j, g, e, d = ""; var b = 0; do { k = c[b++]; h = c[b++]; f = c[b++]; j = k >> 2; g = ((k & 3) << 4) | (h >> 4); e = ((h & 15) << 2) | (f >> 6); d = f & 63; if (isNaN(h)) { e = d = 64 } else { if (isNaN(f)) { d = 64 } } a = a + keyStr.charAt(j) + keyStr.charAt(g) + keyStr.charAt(e) + keyStr.charAt(d); k = h = f = ""; j = g = e = d = "" } while (b < c.length); return a }; keyStr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="; unicodetoBytes = function (d) { var a = new Array(); if (d == null || d == "") { return a } a.push(255); a.push(254); for (var b = 0; b < d.length; b++) { var g = d.charCodeAt(b).toString(16); if (g.length == 1) { b = "000" + g } else { if (g.length == 2) { g = "00" + g } else { if (g.length == 3) { g = "0" + g } } } var f = parseInt(g.substring(2), 16); var e = parseInt(g.substring(0, 2), 16); a.push(f); a.push(e) } return a }; bytesToUnicode = function (b) { var a = ""; var e = 0; if (b.length >= 2 && b[0] == 255 && b[1] == 254) { e = 2 } for (var c = e; c < b.length; c += 2) { var d = b[c] + (b[c + 1] << 8); a += String.fromCharCode(d) } return a } };
	...
	function formatNum(){
		$(".bsNum,.bkNum").each(function(){
			var curValText = $(this).text();
			if(isNaN(curValText)){
				return;
			}

		var dianIndex = curValText.indexOf(".");
			if(dianIndex > 0){
				$(this).html(curValText.substring(0,dianIndex) + "<g>"+curValText.substring(dianIndex)+"</g>");
			}
		});
	}
	...
	;(function($){
	    $.fn.loading = function(curValue,maxValue){
			var curValue = parseFloat(curValue).toFixed(2);
			var maxValue = parseFloat(maxValue);
			var pixSyn = "TH/S";
			var toGet = function(val){
				if((val + 1) % 12 == 0){
					return val + 1;
				}else{
					return toGet(val + 1);
			...
			var getMaxValue = function(val){
				if(val < 10){
					...
					val = parseInt(val);
					var vl = 12 -  parseInt(Number(val) % 12);
					return val + vl;
				}
			};
			if(curValue > 1000){
				curValue = (curValue / 1000).toFixed(2);
				pixSyn = "PH/S";
			}
			if(!maxValue){
				maxValue = getMaxValue(curValue);
			}
			var pixStr   = "<div class='pointer'></div>"; 
			    pixStr   += "<span class='pix-syn'>"+pixSyn+"</span>"; 
			var pixAngle = (curValue*240/maxValue).toFixed(0);
			var pixStep = maxValue/12 ;
			for(var i = 0 ; i < 13 ; i ++){
				var ps = pixStep * i;
				if(ps % 1 == 0){
					pixStr += "<span class='pix-"+i+"'>"+parseInt(ps)+"</span>";
				}else{
					if(curValue < 1)
						pixStr += "<span class='pix-"+i+"'>"+ps.toFixed(2)+"</span>";
					else
						pixStr += "<span class='pix-"+i+"'>"+ps.toFixed(1)+"</span>";
				}
			};
	        return $(this).each(function(){
				$(this).find(".dash-pix").html(pixStr);
				$(this).find(".dash-data").text(curValue);
				$(this).find(".pointer").css({
					'-webkit-transform':'rotate('+pixAngle+'deg)',
					'transform':'rotate('+pixAngle+'deg)'
				})
	        });
	    }; 
	})(jQuery);
	;(function($) {
	    var ms = {
	        init: function(obj, args) {
	            return (function() {
	            	if(args.noPage){
	            		ms.NPfillHtml(obj, args);
		                ms.NPbindEvent(obj, args);
	            	}else{
	        ...
	        NPfillHtml: function(obj, args) {
	            return (function() {
	                obj.empty();
	                if (args.current > 1) {
	                    obj.append('<li class="prevPage"><a href="javascript:;">'+bitbank.L("上一页")+'</a></li>');
	                } else {
	                    obj.remove('.prevPage');
	                    obj.append('<li class="disabled"><a href="javascript:;">'+bitbank.L("上一页")+'</a></li>');
	                }
	                if (args.rsCount < args.pageSize) {
	                    obj.remove('.nextPage');
	                    obj.append('<li class="disabled"><a href="javascript:;">'+bitbank.L("下一页")+'</a></li>');
	                } else {
	                	obj.append('<li class="nextPage"><a href="javascript:;">'+bitbank.L("下一页")+'</a></li>');
	                }
	                obj.wrapInner('<ul class="pagination" />');
	            })();
	        },
	        NPbindEvent: function(obj, args) {
	            return (function() {
	        ...
	        fillHtml: function(obj, args) {
	            return (function() {
	                obj.empty();
	                if (args.current > 1) {
	                    obj.append('<li class="prevPage"><a href="javascript:;"><i class="fa fa-angle-left"></i></a></li>');
	                } else {
	                    obj.remove('.prevPage');
	                    obj.append('<li class="disabled"><a href="javascript:;"><i class="fa fa-angle-left"></i></a></li>');
	                }
	                if (args.current != 1 && args.current >= 4 && args.pageCount != 4) {
	                    obj.append('<li class="tcdNumber"><a href="javascript:;">' + 1 + '</a></li>');
	                }
	                ...
	                for (; start <= end; start++) {
	                    if (start <= args.pageCount && start >= 1) {
	                        if (start != args.current) {
	                            obj.append('<li class="tcdNumber"><a href="javascript:;">' + start + '</a></li>');
	                        } else {
	                ...
	                if (args.current != args.pageCount && args.current < args.pageCount - 2 && args.pageCount != 4) {
	                    obj.append('<li class="tcdNumber"><a href="javascript:;">' + args.pageCount + '</a></li>');
	                }
	                if (args.current < args.pageCount) {
	                    obj.append('<li class="nextPage"><a href="javascript:;"><i class="fa fa-angle-right"></i></a></li>');
	                } else {
	                    obj.remove('.nextPage');
	                    obj.append('<li class="disabled"><a href="javascript:;"><i class="fa fa-angle-right"></i></a></li>');
	                }
	                obj.wrapInner('<ul class="pagination" />');
	            })();
	        },
	        bindEvent: function(obj, args) {
	            return (function() {
	                ...
	                obj.on("click", ".prevPage", function() {
	                    var current = parseInt(obj.find(".active").text());
	                    ms.fillHtml(obj, {
	                        "current": current - 1,
	                        "pageCount": args.pageCount
	                    });
