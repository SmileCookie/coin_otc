    ...
    if (!(t[i] && t[i].version > n)) {
      t[i] = function (t, e) {
        ...
        truncate: function () {
          ...
          var t = !this._fits();
          return this._truncateToNode(this.$inner[0]), this.$dot[t ? "addClass" : "removeClass"](s.truncated), this.$inner.replaceWith(this.$inner.contents()), this.$inner = null, this.opts.callback.call(this.$dot[0], t), t
        },
        restore: function () {
