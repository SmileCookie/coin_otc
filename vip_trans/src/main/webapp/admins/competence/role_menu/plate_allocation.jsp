		...
		<div id="admin_user_update" class="main-bd">
			...
			<div class="win-form-line">
				<c:forEach items="${dataList}" var="data">
					<span class="group-input"><input type="checkbox" value="${data.id }" name="has" <c:if test="${data.inRole}">checked="checked"</c:if>/></span> <span class="group-name">${data.dataDes}</span> 
				</c:forEach>
			</div>
