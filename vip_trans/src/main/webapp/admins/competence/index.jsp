...
function ShowRoles(){
	$("#rolesDiv").empty();
	vip.ajax({
		url : "/admin/competence/role/jsons",
		dataType : "json",
		suc : function(json){
			$.each(json.datas , function(index , cont){
				...
				$("#StepThree").hide("fast");
				var newRoles=$("<span id='roleId_"+cont.id+"' class='roleSpan adelete' ><a href=\"javascript:menu('"+cont.id+"');\" class='roleName' title='生成菜单'>"+cont.roleName+"</a><a href='javascript:void(0);' class='delete iDelete'>&nbsp;&nbsp;&nbsp;&nbsp;</a></span>");
...
function addRole(){
	vip.list.aoru({url : "/admin/competence/menu/aoru"});
}
var currentGroupId="";
//显示组信息
function groups(){
