...
<div class="form-group">
    ...
    <script>
      $(document).ready(function() {
    	  ...
    	  initButton("内外委托界定",
    	    		"内外委托界定，分段委托控制的",
    	    		"entrustRobotQuJian",${rc.entrustRobotQuJian},0,200,1);
    	  initButton("显示增量",
  	    		"显示的成交量增加的数量",
  	    		"baseShowAdd",${rc.baseShowAdd},0,500000,100);
  
    	  insertLine("AI成交");
    	  
    	  initButton("每日成交单总额",
    	    		"AI成交的部分",
    	    		"totalTransEveryDay",${rc.totalTransEveryDay},1,200000,100);
    	  initButton("自动成交时间间隔",
  	    		"自动成交时间间隔",
    	  ...
    	  initButton("内围买盘-数量",
    	    		...
    	    		"numberTotalBuyIn",${rc.numberTotalBuyIn},0,100000,10);
    	  initButton("内围买盘-档位",
    	  ...
    	  initButton("内围买盘-时间间隔",
  	    		"外围买盘的委托时间间隔",
  	    		"timesSpaceBuyIn",${rc.timesSpaceBuyIn},1,600,1);
          
    	  initButton("内围买盘-分割数量",
    	    		"单次请求的最大分割数量",
    	    		"splitNumberBuyIn",${rc.splitNumberBuyIn},1,30,1);
    	...
    	//内围卖盘
    	  ...
    	  initButton("外围买盘-数量",
    	    		"entrustRobotQuJian以下的买盘最大委托数量",
    	    		"numberTotalBuyOut",${rc.numberTotalBuyOut},0,5000,1);
    	  initButton("外围买盘-档位",
  	    		"entrustRobotQuJian以下的买盘最大档位数",
  	    		"maxDangweiBuyOut",${rc.maxDangweiBuyOut},0,2000,10);
    	  initButton("外围买盘-最低价",
    	    		"不能高于当前买一价",
    	    		"lowPriceBuyOut",${rc.lowPriceBuyOut},0,5000,10);
    	...
    	//外围卖盘
    	  ...
    	  initButton("外围卖盘-档位",
  	    		...
  	    		"maxDangweiSellOut",${rc.maxDangweiSellOut},0,2000,10);
    	  initButton("外围卖盘-最高价",
    	    		"必须高于当前卖一价",
    	    		"highPriceSellOut",${rc.highPriceSellOut},10000,19999,100);
      ...
      function tosubmit(){
    	  ...
    	  $.ajax({
    		  type: 'POST',
    		  url: "/admin/robot/saveautoSys-btcdefault",
