...
public class MarketReload extends AdminAction {
    ...
    public void reloadConfig() {
        try {
            ...
            if (Market.reloadMarket()) {
                log.info("5.重新加载市场配置(trans)成功");
                success.append("[5.重新加载市场配置(trans)成功],");
            } else {
                log.error("5.重新加载市场配置(trans)失败");
                error.append("[5.重新加载市场配置(trans)失败],");
            }
