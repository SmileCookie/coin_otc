package com.world.controller.admin.shualiang.ltc;
...
@FunctionAction(jspPath = "/admins/" , des = "LTC刷量设置")
public class Index extends UserAction  {

	@Page(Viewer = "/admins/shualiang/autoSysLtc.jsp") 
	...
	public void autoSysLtc(){ 
		...
		Object obj=Cache.Get("systemDefaultRobotShualiangConfigLTC");
