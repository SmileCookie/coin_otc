 ...
 * @since JDK1.1
 */
public class VipPropertyResourceBundle extends ResourceBundle {
    /**
     ...
     */
    public VipPropertyResourceBundle (InputStream stream) throws IOException {
     ...
     * @since 1.6
     */
    public VipPropertyResourceBundle (Reader reader) throws IOException {
        Properties properties = new Properties();
