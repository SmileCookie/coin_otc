 ...
 * @Auther 魏群
 */
public class CreateNamePictureUtil {
     ...
     * @throws IOException
     */
    public static File generateImg(String name, String outputName)
            throws IOException {
        int width = 100;
        int height = 100;
        ...
        String filename = directory.getCanonicalPath()+ File.separator + outputName + ".jpg";
