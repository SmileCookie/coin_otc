...
@Entity(noClassnameStored = true , value = "authenHistory")
public class AuthenHistory extends StrBaseLongIdEntity{

	/**
	 * 
	 */
	private static final long serialVersionUID = -4888444892655699782L;

	public AuthenHistory(){

	}

	public AuthenHistory(Datastore ds){
		super(ds);
	}
	...
	private String loadImg;//用户上传的身份证照片（手持身份证）
	private String frontalImg;//用户上传的身份证照片（正面图）
	...
	private int authType;// 1.初级认证 2.高级认证
	...
	private int areaInfo;//dalu(1 , "大陆") , gangao(2 , "港澳地区"),taiwan(3 , "台湾地区"),haiwai(4, "海外");
