 ...
 * @version 
 */
public class DownloadAccountBean extends Bean {
	/**
	 * 
	 */
	...
	public long getBgDownloadId() {
		return bgDownloadId;
	}
	public void setBgDownloadId(long bgDownloadId) {
		this.bgDownloadId = bgDownloadId;
	}
}
