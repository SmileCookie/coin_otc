...
<style type="text/css">
	...
	.bk-footer-hd-right ul li a , .bk-footer-hd-right ul li a .iconfont{
		font-size: .35rem;
	}

</style>
  <div class="bk-footer" style="background: #232731;">
		<div class="bk-footer-hd">
			<div class="container">
				...
				<div class="bk-footer-hd-right  clearfix" >
					...
					<ul style="margin-bottom: .185185rem;">
							<li>
						    ...
						    <li style="display: block;padding:3px 0"></li>
							<li>
								<a href="/terms/relief/">
									<i class="iconfont">&#xe67a;</i>
									${L:l(lan,'免责声明') }
							...
							<li>
								<a href="https://github.com/btcwinex/btcwinex-api" target="_blank">
									<i class="iconfont3 icon-apiwendang" style="font-size: .35rem"></i>
									API
								</a>
							</li>
							${"cn".equals(lan) ? '<li><a target="_blank" href="/sitemap" title="网站地图"><i class="iconfont">&#59113;</i> 网站地图</a></li>' : ''}
						</ul>
					<div class="bk-footer-hd-center" style="font-size:.35rem;color: #C8CDD9;">
					...
					<div class="share_it clearfix">
						...
						<%--<a href="${vip_domain}/terms/termsContactUs/" class="item">--%>
							<%--<i class="iconfont">&#xe692;</i>--%>
						<%--</a>--%>
      	...
      	<div class="bk-footer-info" style="font-size: .35rem;">
