...
<div class="form-search">
				<form autocomplete="off" name="searchForm" id="searchContaint">
					<div id="formSearchContainer">
						...
						<p>
							<span>是否锁定：</span>
							<select name="isLocked" id="isLocked" style="width:90px;">
                              <option value="">全部</option>
						...
						<p>
							<span>服务状态：</span>
							<select name="variablesCustomer" id="variablesCustomer" style="width:90px;">
                              <option value="">全部</option>
                              <option value="1">有效客服</option>
                              <option value="0">无效客服</option>
                            </select>
						</p>
						<p>
