...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			document.domain = "${baseDomain}";
			function ok(){
				var actionUrl = "/admin/app/UserOpinions/doaoru";
				vip.ajax( {
	...
	<body>
		...
		<div id="add_or_update" class="main-bd">
			<div class="form-line">
				<div class="form-tit">评论时间：</div>
				<div class="form-con"><fmt:formatDate value="${curData.submitDate }" pattern="yyyy-MM-dd" /></div>
			</div>
			<div class="form-line">
				<div class="form-tit">意见内容：</div>
				<div class="form-con">
					<textarea rows="4" cols="56" disabled="disabled">${curData.content }</textarea>
				</div>
			</div>
			
			<div class="form-line">
				<div class="form-tit">回复：</div>
				<div class="form-con">
					<textarea rows="4" cols="56" name="reply"></textarea>
				</div>
			</div>
