 ...
 <jsp:include page="/admins/top.jsp" />
   <script type="text/javascript" src="${static_domain }/statics/js/common/DatePicker/WdatePicker.js" ></script>
		...
		<script type="text/javascript">
            $(function(){
                vip.list.ui();
                vip.list.basePath = "/admin/reconciliation/";
					...
					<p class="formCloumn">
						...
						<span class="formContainer">
							<span class="spacing">起始时间</span><span class="formcon mr_5">
   								<input type="text" class="Wdate" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd ',lang : 'cn'})" name="beginTime" id="beginTime" size="20"/></span>
