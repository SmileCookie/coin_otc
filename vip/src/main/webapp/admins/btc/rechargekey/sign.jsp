...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function ok(){
				var actionUrl = "/admin/btc/rechargekey/doSign";
				vip.ajax( {
	...
	<body>
		...
		<div class="form-line">
			...
			<div class="form-con"><input type="text" pattern="limit(6,6)" value="" errormsg="请输入正确的google验证码" style="width:200px;" name="mCode" id="mCode" /></div>
		</div>
		<div class="form-btn" style="padding: 15px 0 0 80px;">
			<input type="hidden" name="coint" value="${coint.propTag }"  />
