...
function ok(){
	...
	parent.confirmAll($("#isAll").val(),datas);
// 	var actionUrl = "/admin/btc/download/confirm"+"?coint=${coint.propTag }";
// 	vip.ajax({
// 		formId : "bankBox",
// 		url : actionUrl,
// 		div : "bankBox",
...
<div class="bankbox_bd">
	...
	<div class="form-line">
		<div class="form-tit">转出总数量：</div>
		<div class="form-con">
			<fmt:formatNumber value="${totalAmount }" pattern="0.0000####"/>
			<input type="hidden" id="money" value="${totalAmount}"/>
		</div>
	</div>
