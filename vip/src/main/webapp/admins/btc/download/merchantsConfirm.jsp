...
function ok(mCode){
	...
	var actionUrl = "/admin/btc/download/doMerchantsConfirm";
	vip.ajax({
		formId : "bankBox",
		url : actionUrl,
		div : "bankBox",
...
<div class="bankbox_bd">
	...
	<div class="form-line">
		...
		<div class="form-con">
			<fmt:formatNumber value="${curData.amount }" pattern="0.0000####"/> - <fmt:formatNumber value="${curData.fees }" pattern="0.0000####"/> = 
	...
	<div class="form-line">
		...
		<div class="form-con">
			<input type="password" class="input" name="mCode" id="mCode" value="" pattern="limit(4,10)"/>
		</div>
	</div>	
