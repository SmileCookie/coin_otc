...
<head>
<title>btcwinex.Com后台管理中心</title>
			...
			<tr>
				<td width="185px" valign="top" id="leftList">
					<div class="leftArea" id="leftArea">
						<div class="logo"></div>
						<div class="administratorinfo" id="userMsg">
				...
				<td style=" vertical-align: top; background-color: white;" id="rightIframe">
					<iframe scrolling="yes" height="100%" frameborder="0" width="100%" id="Main" name="Main" src=""></iframe>
				</td>
			</tr>
		</tbody>
	</table>
