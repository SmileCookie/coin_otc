			...
			<form autocomplete="off" name="searchForm" id="searchContaint">
				<div class="form-search" id="searchContaint">
					<div class="formline">
						...
						<span style="float:left;" class="formtit">条件筛选：</span> 
						<span style="float:left;margin: 2px 20px 0 0px;" class="formcon">
							<select name="group" id="group" style="width:140px;display: none;" selectid="select_24962645">
					           	<option value="">全部</option>
				             	<option value="00">今日上班</option>
				             	<option value="24">今日下班</option>
				             	<option value="day">任意日期</option>
					         </select>
...
$(function(){
 	vip.list.ui();
	vip.list.funcName = "账户结算";
	vip.list.basePath = "/admin/financial/balance/";
...
function memo(id){
	Iframe({
	    Url:"/admin/financial/balance/memo?id="+id,
        zoomSpeedIn		: 200,
        zoomSpeedOut	: 200,
        Width:560,
        Height:300,
