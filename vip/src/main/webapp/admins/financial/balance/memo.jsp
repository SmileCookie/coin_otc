...
function ok() {
	var actionUrl = "/admin/financial/balance/domemo";
	vip.ajax( {
		formId : "bankBox",
		url : actionUrl,
		div : "bankBox",
...
<div class="bankbox_bd">
	...
	<div class="form-line">
	    ...
	    <div class="form-con">
	    	<textarea rows="3" cols="50" id="memo" errormsg="请正确填写备注信息" mytitle="请正确填写备注信息" name="memo" pattern="limit(0,500)">${balance.memo}</textarea>
	  	</div>
	</div>
