...
<head>
    ...
    <script type="text/javascript">
        ...
        function ok() {
            var actionUrl = "/admin/financial/settlement/doAoru";
            vip.ajax({
                formId: "bankBox",
                url: actionUrl,
                div: "bankBox",
...
<div class="bankbox" id="bankBox">
    ...
    <div class="bankbox_bd">
        ...
        <div class="form-line">
            ...
            <div class="form-con">
                <input type="text" class="input" style="width:100px;" name="mCode" id="mCode" value=""
                       mytitle="请输入移动设备上生成的验证码。" errormsg="验证码错误" pattern="limit(4,10)"/>
            </div>
        </div>
