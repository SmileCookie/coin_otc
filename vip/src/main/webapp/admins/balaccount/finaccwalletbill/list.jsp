...
<head>
   ...
   <script type="text/javascript" src="${static_domain }/statics/js/common/DatePicker/WdatePicker.js" ></script> 
		<script type="text/javascript">
			$(function(){ 
			 	vip.list.ui();
			 	vip.list.basePath = "/admin/balaccount/finaccwalletbill/";
			});
		...
		<script type="text/javascript">
			function exportWalletBill(){
				...
				if(!couldPass){
					googleCode("exportWalletBill", true);
					return;
				}
				couldPass = false;
				Close();
				var fundsType = $("#fundsType").val();
				var actionUrl = "/admin/balaccount/finaccwalletbill/exportWalletBill?fundsType="+fundsType;
			...
			<form autocomplete="off" name="searchForm" id="searchContaint">
				...
				<div id="formSearchContainer">
					...
					<p>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a class="search-submit" href="javascript:exportWalletBill();">导出excel</a>
					</p>
				</div>
			</form>
		</div>
