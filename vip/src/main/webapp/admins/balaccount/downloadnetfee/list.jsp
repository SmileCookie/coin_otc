...
<head>
		...
		<title>现网络费对账-交易平台VS支付中心</title>
   <jsp:include page="/admins/top.jsp" />
   <script type="text/javascript" src="${static_domain }/statics/js/common/DatePicker/WdatePicker.js" ></script> 
		<script type="text/javascript">
			$(function(){ 
			 	vip.list.ui();
			 	vip.list.basePath = "/admin/balaccount/downloadnetfee/";
			});
		...
		<script type="text/javascript">
			function exportDownloadAccount(){
				...
				var actionUrl = "/admin/balaccount/downloadnetfee/exportDownloadAccount?fundsType="+fundsType;
