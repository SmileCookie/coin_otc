...
<head>
   ...
   <script type="text/javascript" src="${static_domain }/statics/js/common/DatePicker/WdatePicker.js" ></script> 
		<script type="text/javascript">
			$(function(){ 
			 	vip.list.ui();
			 	vip.list.basePath = "/admin/balaccount/walletnetfee/";
			});
		...
		<script type="text/javascript">
			function exportWalletnetFee(){
				...
				if(!couldPass){
					googleCode("exportWalletnetFee", true);
					return;
				}
				couldPass = false;
				Close();
				var fundsType = $("#fundsType").val();
				var actionUrl = "/admin/balaccount/walletnetfee/exportWalletnetFee?fundsType="+fundsType;
			...
			<form autocomplete="off" name="searchForm" id="searchContaint">
				...
				<div id="formSearchContainer">
					...
					<p>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a class="search-submit" href="javascript:exportWalletnetFee();">导出excel</a>
					</p>
				</div>
			</form>
		</div>
