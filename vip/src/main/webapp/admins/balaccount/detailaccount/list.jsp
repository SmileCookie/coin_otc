...
<head>
   ...
   <script type="text/javascript" src="${static_domain }/statics/js/common/DatePicker/WdatePicker.js" ></script> 
		<script type="text/javascript">
			$(function(){ 
			 	vip.list.ui();
			 	vip.list.basePath = "/admin/balaccount/detailaccount/";
			});
		...
		<script type="text/javascript">
			function exportDetailAccount(){
				...
				if(!couldPass){
					googleCode("exportDetailAccount", true);
					return;
				}
				couldPass = false;
				Close();
				var fundsType = $("#fundsType").val();
				var actionUrl = "/admin/balaccount/detailaccount/exportDetailAccount?fundsType="+fundsType;
			...
			<form autocomplete="off" name="searchForm" id="searchContaint">
				...
				<div id="formSearchContainer">
					...
					<p>
						...
						<span class="formContainer">
							<span class="formcon mr_5">
   								<input type="text" name="detailsId" id="detailsId" size="16"/>(精确)
   							</span>
						</span>
					</p>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
					...
					<p>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a class="search-submit" href="javascript:exportDetailAccount();">导出excel</a>
					</p>
				</div>
			</form>
		</div>
