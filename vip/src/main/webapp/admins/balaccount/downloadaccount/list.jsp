...
<head>
   ...
   <script type="text/javascript" src="${static_domain }/statics/js/common/DatePicker/WdatePicker.js" ></script> 
		<script type="text/javascript">
			$(function(){ 
			 	vip.list.ui();
			 	vip.list.basePath = "/admin/balaccount/downloadaccount/";
			});
		...
		<script type="text/javascript">
			function exportDownloadAccount(){
				...
				if(!couldPass){
					googleCode("exportDownloadAccount", true);
					return;
				}
				couldPass = false;
				Close();
				var fundsType = $("#fundsType").val();
				var actionUrl = "/admin/balaccount/downloadaccount/exportDownloadAccount?fundsType="+fundsType;
		...
		<div class="form-search">
			<form autocomplete="off" name="searchForm" id="searchContaint">
				...
				<div id="formSearchContainer">
					...
					<p>
						...
						<span class="formContainer">
							<span class="formcon mr_5">
   								<input type="text" name="downloadId" id="downloadId" size="16"/>(精确)
   							</span>
						</span>
					</p>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
					...
					<p>
						<span>处理状态：</span>
						<select name="dealStauts" id="dealStauts" selectid="select_dealStauts" style="display: none;">
							<option value="0">--请选择--</option>
							<option value="2">成功</option>
							<option value="1">失败</option>
						</select>
						<div class="SelectGray" id="select_dealStauts">
							<span><i style="width: 70px;">--请选择--</i></span>
						</div>
					</p>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
					<p>
						<span>是否一致：</span>
						<select name="balanceFlag" id="balanceFlag" selectid="select_balanceFlag" style="display: none;">
							<option value="0">--请选择--</option>
							<option value="1">一致</option>
							<option value="2">不一致</option>
						</select>
						<div class="SelectGray" id="select_balanceFlag">
							<span><i style="width: 70px;">--请选择--</i></span>
						</div>
					</p>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
					...
					<p>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a class="search-submit" href="javascript:exportDownloadAccount();">导出excel</a>
					</p>
				</div>
			</form>
		</div>
