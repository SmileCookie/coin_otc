...
<link href="${static_domain }/statics/css/en/upload.css"
	rel="stylesheet" type="text/css" />

<script type="text/javascript"
	src="${static_domain }/statics/js/common/upload.js"></script>
<script type="text/javascript"
	src="${static_domain }/statics/js/common/DatePicker/WdatePicker.js"></script>
			...
			<c:choose>
				<c:when test="${tradeList!=null}">
					<c:forEach items="${tradeList}" var="entity">
						<tr>
							<td><fmt:formatDate value="${entity.timeDate}"
									pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate></td>
							<td><span class="${entity.isBuy == 1 ? 'red' : 'green'}"><fmt:formatNumber
										value="${entity.unitPrice}" pattern="0.000000#" /></span></td>
							<td><fmt:formatNumber value="${entity.numbers}"
									pattern="0.000##" /></td>
							<td><a href="javascript:#"
								style="font-weight: bold;" class="red">${entity.userNameBuy}</a></td>
							<td>${entity.entrustIdBuy}</td>
							<td><a href="javascript:#"
								style="font-weight: bold;" class="green">${entity.userNameSell}</a></td>
							<td>${entity.entrustIdSell}</td>
						</tr>
					</c:forEach>
