	...
	<body>
		<div id="admin_user_update" class="main-bd">
			...
			<div class="form-line">
				...
				<div class="form-con">
					<input name="status"  type="radio" value="1" ${curData.status=="1" ? "checked='checked'" : "" }  /><span style="float: left;">可用</span>
                    <input  type="radio" name="status" value="0"  ${curData.status=="0" ? "checked='checked'" : "" }/><span style="float: left;">不可用</span>
				</div>
			</div>
