...
<div id="editor-container" class="container">
    <div id="simple">
    <div >活动描述简体：</div>
    <div id="editor-trigger" name ="activityContentSimple" id="activityContentSimple">
        <p>${n.activityContentSimple }</p>
    </div>
    <div >活动规则描述简体：</div>
    <div id="editor-trigger1" name ="activityRuleSimple">
        <p>${n.activityRuleSimple }</p>
    </div>
    </div>
...
<div id="editor-container1" class="container">
    <div id="simple">
        <div >活动描述繁体：</div>
        <div id="editor-trigger2" name ="activityContentTraditional">
            <p>${n.activityContentTraditional }</p>
        </div>
        <div >活动规则描述繁体：</div>
        <div id="editor-trigger3" name ="activityRuleTraditional">
            <p>${n.activityRuleTraditional  }</p>
        </div>
    </div>
</div>
<div id="editor-container2" class="container">
    <div id="simple">
        <div >活动描述英文：</div>
        <div id="editor-trigger4" name ="activityContentEnglish">
            <p>${n.activityContentEnglish }</p>
        </div>
        <div >活动规则描述英文：</div>
        <div id="editor-trigger5" name ="activityRuleEnglish">
            <p>${n.activityRuleEnglish }</p>
        </div>
    </div>
</div>
