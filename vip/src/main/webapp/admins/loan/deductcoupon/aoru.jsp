				...
				suc : function(json){
					if(json.isSuc){
						 ...
						 for(var i = 0;i < datas.length; i++){
						 	content += (i+1)+"." + datas[i].secretkey + "\n";
						 }
						 html += "<tr>";
						 html += "<td> <textarea  cols='45' rows='25'>"+content+"</textarea><td>";
						 html += "</tr>";
						 $("#head").after(html);
						 $("#form1").hide();
						 $("#showSecretDiv").show();
	...
	<body>
		<div id="form1" class="main-bd">
			<div class="form-line">
				...
				<div class="form-con">
				<input type="text" id="title" name="title" pattern="limit(0,20)"
					size="20" mytitle="请填写本次抵扣券标题" errormsg="请填写本次抵扣券标题" />
			</div>
			</div>
			...
			<div class="form-line">
				...
				<div class="form-con">
					<input type="radio" name="getWay" value="1" checked/>活动发放
					<input type="radio" name="getWay" value="2" />系统赠送
				</div>
			</div>
...
<!-- 			</div> -->
			...
			<div class="form-line">
				...
				<textarea type="text" id="useCondition" name="useCondition"
					...
					mytitle="可以添加一些描述性文字" errormsg="长度太长，不能超过50个字符"></textarea>
			</div>
			</div>	
...
<!-- 			<div class="form-line"> -->
<!-- 				<div class="form-tit">本批券标识：</div> -->
<!-- 				<div class="form-con"> -->
<!-- 					<input type="text" name="batchMark" id="batchMark" class="dai_input"/> -->
<!-- 				</div> -->
<!-- 			</div> -->
		...
		<div id="showSecretDiv" style="display:none;">
			<table style="width:90%;margin-top:10px;margin-left:5%;">
				<tr id="head">
					<th style="text-align:center;border:1px solid #c6c6c6">抵扣券密钥</th>
				</tr>
			</table>
		</div>
	</body>
