...
<body>
   <div id="add_or_update" class="main-bd">
      ...
      <div class="form-line">
         <div class="form-tit">原用户名：</div>
         <div class="form-con">
            ${user.userName }
         </div>
      </div>
      <div class="form-line">
         <div class="form-tit">新用户名：</div>
         <div class="form-con">
            <input class="txt" style="width: 100px" type="text" name="newUserName" id="newUserName" value="" mytitle="请输入新的用户名。" pattern="limit(1, 30)" errormsg="请输入正确的用户名。"/>
         </div>
      </div>
      <div class="form-line">
...
function ok(){
	var actionUrl = "/admin/user/show/saveUsername";
	vip.ajax( {
