...
function ok(){
	var actionUrl = "/admin/user/show/savepayuser";
	vip.ajax( {
		formId : "bankBox",
		url : actionUrl,
		div : "bankBox",
...
<div class="bankbox_bd">
	...
	<div class="form-line">
		<div class="form-tit">壹币计划额度：</div>
		<div class="form-con">
		 	<input class="input" name="dayCash" id="dayCash" value="<fmt:formatNumber value='${onecoin}' pattern='0.00'/>" mytitle="如果为0，则按默认额度。" pattern="limit(0, 30)"/>
		</div>
	</div>
