...
function ok(){
	var actionUrl = "/admin/user/show/saveSingleWithdrawal";
	vip.ajax( {
		formId : "bankBox",
		url : actionUrl,
		div : "bankBox",
...
<div class="bankbox_bd">
	...
	<div class="form-line">
		<div class="form-tit">${coint.propTag }单次最大提现额度：</div>
		<div class="form-con">
		 	<input class="input" name="singleWithdrawal" id="singleWithdrawal" value="<fmt:formatNumber value='${bUser.amountOfSingle}' pattern='0.00'/>" mytitle="如果为0，则按默认额度。" pattern="limit(0, 30)"/>
		</div>
	</div>
	...
	<div class="form-btn">
		<input type="hidden" id="userId" name="userId" value="${bUser.userId}" />
		<input type="hidden" id="coint" name="coint" value="${coint.stag}" />
