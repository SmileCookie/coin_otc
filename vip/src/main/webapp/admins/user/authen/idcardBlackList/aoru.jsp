...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			document.domain = "${baseDomain}";
			function ok(){
				var actionUrl = "/admin/user/authen/idcardBlackListAction/doaoru";
				vip.ajax( {
	...
	<body>
		<div id="add_or_update" class="main-bd">
			<div class="form-line">
				...
				<div class="form-con">
					<input name="cardNo" value="${entity.cardNo}" size="30"/>
				</div>
			</div>
			<div class="form-line">
				<div class="form-tit">备注：</div>
				<div class="form-con">
					<textarea rows="3" cols="40" name="remark" >${entity.remark}</textarea>
				</div>
			</div>
