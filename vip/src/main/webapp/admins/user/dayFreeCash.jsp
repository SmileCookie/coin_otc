...
function ok(){
	var actionUrl = "/admin/user/show/saveDayFreeCash";
	vip.ajax( {
		formId : "bankBox",
		url : actionUrl,
		div : "bankBox",
...
<div class="bankbox_bd">
	...
	<div class="form-line">
		<div class="form-tit">${coint.propTag }免审额度：</div>
		<div class="form-con">
		 	<input class="input" name="dayFreeCash" id="dayFreeCash" value="<fmt:formatNumber value='${bUser.dayFreeCash}' pattern='0.00'/>" mytitle="如果为0，则按默认额度。" pattern="limit(0, 30)"/>
		</div>
	</div>
