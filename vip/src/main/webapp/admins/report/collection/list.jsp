...
<head>
   ...
   <script type="text/javascript" src="${static_domain }/statics/js/common/DatePicker/WdatePicker.js" ></script> 
		<script type="text/javascript">
			$(function(){ 
			 	vip.list.ui();
			 	vip.list.basePath = "/admin/report/collection/";
			});
		...
		<script type="text/javascript">
			function exportFinAccWalDailyAcc(){
				...
				var actionUrl = "/admin/report/collection/exportFinAccWalDailyAcc?fundsType="+fundsType;
...
<body>
<div class="mains" style="width:2100px; overflow:scroll;">
	<div class="col-main">
		...
		<div class="tab-body" id="shopslist" style="width:2075px; overflow:scroll;">
