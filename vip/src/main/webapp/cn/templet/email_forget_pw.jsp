...
<div style="padding: 2px 20px 30px;">
	<p>
		${L:l1(lan,"%%,您好！",email)}<br/>
	</p>
	<p>
		${L:l(lan,"您正在注册成为XXXXX会员，请点击下面链接激活你的注册地址。")}<br/>
	</p>
	<p style="width: 100%; overflow: hidden; word-wrap: break-word;">
		<a title='${L:l(lan,"点击认证邮箱") }' href="${vip_domain }/register/emailConfirmFg?emailCode=${emailCode }" target="_blank" swaped="true">${vip_domain }/register/emailConfirmFg?emailCode=${emailCode }</a> <br />
	</p>
	<p>
		<br />
        <font color='#CCCCCC'>
