...
<div style="padding: 2px 20px 30px;">
	<p>
		${L:l1(lan,"%%,您好！",user.userName) }
	</p>
	<p>
		${L:l(lan,"请点击下面链接") }
	</p>
	<p style="width: 100%; overflow: hidden; word-wrap: break-word;">
		<a href="${vip_domain }/user/authAddress?auth=${auth}&type=${type}" target="_blank" swaped="true">${vip_domain }/user/authAddress?auth=${auth}&type=${type}</a> <br />
	</p>
	<p>
		<br />
