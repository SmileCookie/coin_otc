...
<div style="padding: 2px 20px 30px;">
	...
	<p>
		${L:l1(lan,"很抱歉，您的身份认证未通过审核。失败原因：%%。您可以点击这里重新申请身份认证。",reason)}
	</p>
	<p style="width: 100%; overflow: hidden; word-wrap: break-word;">
		<a title='${L:l(lan,"重新认证") }' href="${vip_domain }/manage/auth/authentication?fromUrl=${fromUrl}" target="_blank" swaped="true">${vip_domain }/manage/auth/authentication?fromUrl=${fromUrl}</a> <br />
	</p>
    <p>
        <br />
        <font color='#CCCCCC'>
