...
<div style="padding: 2px 20px 30px;">
	...
	<p style="width: 100%; overflow: hidden; word-wrap: break-word;">
		<a title='${L:l(lan,"点击认证邮箱") }' href="${vip_domain }/register/emailConfirm?emailCode=${emailCode }" target="_blank" swaped="true">${vip_domain }/register/emailConfirm?emailCode=${emailCode }</a> <br />
	</p>
	<p>
		<br />
        <font color='#CCCCCC'>
