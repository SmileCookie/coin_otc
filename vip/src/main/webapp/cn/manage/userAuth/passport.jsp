			...
			<div class="user_auth_id_text">
				...
				<div class="id_text_wrap clearfix">
					...
					<div class="id_item marr_100 marr_${lan} clearfix">
						<span class="name_text name_text_1 ${lan} left">${L:l(lan,'名字')}：</span>
					...
					<div class="id_item">
						<span class="name_text name_text_2 ${lan}">${L:l(lan,'护照号码')}：</span>
						<div class="id_text_input_wrap">
							<input id="passport" class="id_text_input" type="text" name="id_name" value="" autocomplete="off" />
						</div>
					</div>
					<div class="id_item marr_100 marr_${lan} clearfix">
				...
				<div class="id_imgfile_warp">
					<h3 class="h3_file">${L:l(lan,'上传护照照片')}</h3>
					<div class="file_item clearfix" id="qiniu_1">
						<div class="file_img_item">
							<img class="id_imgs" src="${static_domain }/statics/img/user/user_id_2.png" alt="">
						</div>
						...
						<div class="file_img_item">
							...
							<div class="file_text_1">${L:l(lan,'请上传护照照片')}</div>
							<div class="file_img" id="file_img_1"></div>
						</div>
						<div class="file_text">
							<div class="files">
								<input type="file" class="file_img_1" id="file_input_1" name="file" value="">
								<div class="file_warp">
									${L:l(lan,'选择文件')}
								</div>
							</div>
					...
					<div class="file_item clearfix" id="qiniu_2">
						<div class="file_img_item">
							<img class="id_imgs" src="${static_domain }/statics/img/user/user_id_6.png" alt="">
						</div>
						<div class="file_jiantou">
							<span class="user_id_you"></span>
							${L:l(lan,'示例')}
						...
						<div class="file_img_item">
							<span class="id_user_id"></span>
							<div class="file_text_2">${L:l(lan,'请上传手持护照照片')}</div>
							<div class="file_img" id="file_img_2"></div>
						</div>
						<div class="file_text">
							<div class="files">
								<input type="file" class="file_img_2" id="file_input_2" name="file" value="">
								<div class="file_warp">
									${L:l(lan,'选择文件')}
								</div>
							</div>
