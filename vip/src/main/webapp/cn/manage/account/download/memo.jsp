...
.loan-info-list li { height: 34px; line-height: 34px; color: #666666; text-align: left; }
...
.loan-info-list li input { width: 140px; padding: 5px 10px; height: 32px; line-height: 22px; font-size: 12px; color: #666; }
...
<div class="loan-info" id="uimain">
  <ul class="loan-info-list">
    ...
    <li><span class="tit">备注：</span>
      <input name="memo" type="text" value="${entity.memo}" style="width: 270px;"/> 
      </li>
      </ul>
  <hr/>
  <div class="do">
    <input type="hidden" name="id" value="${entity.btcReciveAddressId}"/>
