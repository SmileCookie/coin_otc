...
<section class="news_mainer bbyh-dk">
    <section class="news_container">
        <div class="terms_main clearfix">
            ...
            <h6 class="lintH32">비고：</h6>
            <p>
                1、일반 사용자의 포인트는 해당한 정도로 되면 자동적으로 해당한 VIP 등급으로 될 수 있습니다. <br/>
                2、운영 정책에 따라서 Btcwinex는 VIP규칙을 조정할 수도 있습니다.
            </p>
        </div>
    </section>
</section>
