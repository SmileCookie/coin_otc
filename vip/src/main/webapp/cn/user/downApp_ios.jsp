...
<div class="bk-body">
    ...
    <div class="content">
        <div class="content">
            ...
            <ul class="btn-box ">
                <li class="clear">
                    <a class="btn" href="itms-services://?action=download-manifest&url=https://www.btcwinex.com/downloadOnlyApp/manifest.plist" style="padding: 0.2rem 0 0 0.5rem;">
                        <div class="btn-img">
                            <img src="${static_domain }/statics/images/ios (2)-2@2x.png" alt="">
                        </div>
                        <p class="btn-text" style="line-height: 1rem;">${L:l(lan,'本地下载')}</p>
                    </a>
                </li>
                <%--<li class="clear">--%>
                    <%--<a class="btn" href="javascript:void(0);">--%>
                        <%--<div class="btn-img">--%>
                            <%--<img src="${static_domain }/statics/images/App Store (1)-2@2x.png" alt="">--%>
                        <%--</div>--%>
                        <%--<p class="btn-text">${L:l(lan,'前往App')}</p>--%>
                    <%--</a>--%>
                <%--</li>--%>
            </ul>
